...
FetchWebDev() {
  curl -L https://codeload.github.com/BestCatKaryl/web-dist/tar.gz/refs/heads/dev -o web-dist-dev.tar.gz
...
FetchWebRelease() {
  curl -L https://github.com/BestCatKaryl/alist-web/releases/latest/download/dist.tar.gz -o dist.tar.gz
